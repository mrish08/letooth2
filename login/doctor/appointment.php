...
<?php include'../assets/sidebar.php'?>
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark"><i class="fa fa-th"></i> Pending Appointments </h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
  ...
  <?php foreach ($g as $key => $value):?>
    <tr>
      ...
      <td>
        <a href="view-billing.php?ds_id=<?php echo $value->ds_id?>" class="btn btn-success btn-sm"><i class="fa fa-file"></i> View</a>
      </td>
    </tr>
