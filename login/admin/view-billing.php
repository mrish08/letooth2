<?php 
  ...
  if(isset($_POST['pay_btn'])){
    ...
    if($getPayment['service_price'] > $_POST['payment']){
      ...
      $msg = 'Please be informed that the customer already paid worth: '.$_POST['payment'].'';
      $msg2 = 'PAYMENT DONE: Please be informed that you have successfully paid the service of your appointment.';
      $notification = array(
        "ds_id"             =>$_GET['ds_id'],
        "notif_status"      =>"0",
        "notif_type"        =>"1",
        "notif_user"        =>$getData['ID'],
        "notif_desc"        =>$msg,
...
<strong>Recommendations / Actions Made:</strong>
<p></p>
...
<hr>
              ...
              <div class="row no-print">
                ...
                <div class="col-6">
                <?php if($getData['sched_status'] == '3'):?>
                <?php elseif($getData['sched_status'] == '2' AND $getData['paypal_status'] == '0'):?>
                 <form method="post">
                  <div class="row">
                    <div class="col-md-8">
