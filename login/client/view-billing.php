...
<?php endwhile;?>
              ...
              <?php if($getData['sched_status'] == '1'):?>
                 <div class="alert alert-primary"><i class="fa fa-warning"></i> PENDING FOR APPROVAL</div>
              <?php elseif($getData['sched_status'] == '2'):?>
                <div class="alert alert-danger"><i class="fa fa-calendar"></i> RESERVED</div>
              <?php elseif($getData['sched_status'] == '3'):?>
                <div class="alert alert-success"><i class="fa fa-check"></i> PAID: Fulfilled</div>
              <?php endif;?>
                </div>
                <!-- /.col -->
                <div class="col-6">
