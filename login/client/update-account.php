    ...
    <!-- Main content -->
      ...
      <form method="post">
          ...
          <div class="col-md-6">
            ...
            <input type="email" name="UserName" class="form-control" placeholder="Email Address / Username" value="<?php if(isset($_POST['save_button'])): echo $_POST['UserName']; elseif(isset($_GET['ID'])): echo $getInfo['UserName'];endif;?>" >
          </div>
          <div class="col-md-6">
            <strong>Email Address:</strong><br>
            <input type="email" name="EmailAddress" class="form-control" placeholder="Email Address" value="<?php if(isset($_POST['save_button'])): echo $_POST['EmailAddress']; elseif(isset($_GET['ID'])): echo $getInfo['EmailAddress'];endif;?>">
          </div>
        ...
        <div class="row">
          ...
          <div class="col-md-6">
            ...
            <input type="text" name="MiddleName" class="form-control" placeholder="Middle Name" required value="<?php if(isset($_POST['save_button'])): echo $_POST['MiddleName']; elseif(isset($_GET['ID'])): echo $getInfo['MiddleName'];endif;?>">
          </div>
        </div><br>
        <div class="row">
          <div class="col-md-6">
          ...
          <div class="col-md-6">
            ...
            <input type="text" name="ContactNumber" class="form-control" placeholder="Contact Number" required value="<?php if(isset($_POST['save_button'])): echo $_POST['ContactNumber']; elseif(isset($_GET['ID'])): echo $getInfo['ContactNumber'];endif;?>">
          </div>
        </div><br>
        <div class="row">
          <div class="col-md-12">
        ...
        <?php if($_GET['type'] != 'doctor'):?>
          ...
          <div class="col-md-6">
            ...
            <input type="number" name="user_age" class="form-control" placeholder="Age" required value="<?php if(isset($_POST['save_button'])): echo $user_age;elseif(isset($_GET['ID'])): echo $getInfo['user_age']; endif;?>">
          </div>
          <div class="col-md-6">
